...
$oid=$_GET['orderid'];
$query=mysqli_query($con,"select tblproduct.Image,tblproduct.ItemName,tblproduct.ItemDes,tblproduct.ItemPrice,tblproduct.ItemQty,tblorders.ProductId from tblorders join tblproduct on tblproduct.ID=tblorders.ProductId where tblorders.UserId='$userid' and tblorders.IsOrderPlaced=1 and tblorders.OrderNumber='$oid'");
