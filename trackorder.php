...
$ret=mysqli_query($con,"select tblproducttracking.OrderCanclledByUser,tblproducttracking.remark,tblproducttracking.status as fstatus,tblproducttracking.StatusDate from tblproducttracking where tblproducttracking.OrderId ='$orderid'");
$cnt=1;
...
<table border="1"  cellpadding="10" style="border-collapse: collapse; border-spacing:0; width: 100%; text-align: center;">
  <tr align="center">
   <th colspan="4" >Product Tracking History of #<?php echo  $orderid;?></th> 
  </tr>
  <tr>
    <th>#</th>
<th>Remark</th>
