...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <p><span class="primary-color"><strong>Save Big on ur Monthly Grocery List</strong></span> </div>
            </p>
                            ...
                            <div class="sidebar clearfix m-b-20">
                                ...
                                <div class="main-block">
                                 ...
                                 <button class="btn btn-secondary search-btn" type="submit" name="search"><i class="fa fa-search"></i></button> 
                                    ...
                                    <div class="sidebar-title white-txt">
                                        <h6>Categories</h6> <i class="fa fa-cutlery pull-right"></i> </div>
                               <?php
                     ...
                     <div class="col-xs-12 col-sm-7 col-md-8 col-lg-9">
                            <div class="row">
                                <!-- Each popular food item starts -->
                                                    <?php
 $cid=$_GET['catid'];
$ret=mysqli_query($con,"select * from tblproduct where CategoryName='$cid'");
$cnt=1;
