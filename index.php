...
$query=mysqli_query($con,"insert into tblorders(UserId,ProductId) values('$userid','$productid') ");
if($query)
{
...
#carousel .carousel-item.boat {
  background-image: url("https://t3.ftcdn.net/jpg/01/63/13/30/360_F_163133061_TlMOMqgxAvBuwzLAjxOQ8v1FQ3OexfRG.jpg");
}

#carousel .carousel-item.sea {
  background-image: url("https://png.pngtree.com/thumb_back/fw800/back_our/20190620/ourmid/pngtree-healthy-fruits-and-vegetables-green-leaves-literary-green-banner-image_172881.jpg");
}

#carousel .carousel-item.river {
  background-image: url("https://media.istockphoto.com/id/1191634648/photo/frame-of-fresh-organic-vegetables-with-spices-and-oil.jpg?s=612x612&w=0&k=20&c=vEXenY_cHZ7W2Z1_qipl-5V4RE-CXt2vJGzBrL-fwmo=");
}
...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <!-- banner part starts -->
        <!--<section class="hero bg-image" data-image-src="images/1b.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Greenkart E-Vegitable</h1>
                    <h5 class="font-white space-xs">Get Free Home Delivery</h5>
                    <div class="banner-form">
                        <form class="form-inline" method="post" name="search" action="search-product.php">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to order....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount"  name="searchdata" id="searchdata" placeholder="I would like to order...."> </div>
                            </div>
                            <button onclick="location.href='search-product.php'" type="submit" name="search" class="btn theme-btn btn-lg">Search </button>
                        </form>
                    </div>
                    <div class="steps">
        ...
        <div class="row align-items-center h-100">
          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="caption animated fadeIn">
              ...
              <p class="animated fadeInRight">Welcome to Greenkart, Order your vegetables . we vegetable are fresh and imported directly from farmer </p>
  ...
  <a class="carousel-control-next" href="#carousel" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>Incredibly Low Prices: <span class="primary-color">On All Grocery Products</span> </span>
            </div>
        </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Free Home Delivery / No Minimum Order</p>
                </div>
...
$ret=mysqli_query($con,"select * from tblproduct order by rand() limit 9");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {

?>
                    <div class="col-xs-11 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class=" bg-image"><img src="admin/itemimages/<?php echo $row['Image'];?>" width="370" height="240">
                                
                                
                            </div>
                            <br>
                            <div class="content">
                                <h5><a href="product-detail.php?fid=<?php echo $row['ID'];?>"><?php echo $row['ItemName'];?></a></h5>
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We"ve got your covered with menus from over 345 delicious sweets online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Delivery</h3>
                                <p>Get your sweets delivered! And make ur day delicious! Pay Cash on delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
