                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        <div class="menu-widget m-b-30">
                            <div class="widget-heading">
                              ...
                              Your ORDERS <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular" aria-expanded="true">
...
<?php 
$userid= $_SESSION['fosuid'];
$query=mysqli_query($con,"select tblorders.ID as frid,tblproduct.Image,tblproduct.ItemName,tblproduct.ItemDes,tblproduct.ItemPrice,tblproduct.ItemQty,tblorders.ProductId from tblorders join tblproduct on tblproduct.ID=tblorders.ProductId where tblorders.UserId='$userid' and tblorders.IsOrderPlaced is null");
...
<h6><a href="product-detail.php?fid=<?php echo $_SESSION['fid']=$row['FoodId'];?>"><?php echo $row['ItemName']?> (<?php echo $row['ItemQty']?>) </a></h6>
